...
@implementation XYCameraSession
@synthesize viewport;

- (id)initWithDelegate:(id<XYCameraSessionControl>) delegate
{
    self = [super init];
    if (self) {
