...
- (void)prepareForData
{
    ...
    [self.infoArray addObject:@{@"favorite": @"计算机、文学", @"username": @"忘.惑", @"distance": @"12米"}];
    ...
    [self.infoArray addObject:@{@"favorite": @"儿童文学、艺术", @"username": @"小鲸鱼", @"distance": @"16米"}];
    ...
    [self.infoArray addObject:@{@"favorite": @"计算机", @"username": @"非天离巢", @"distance": @"20米"}];
    ...
    [self.infoArray addObject:@{@"favorite": @"侦探小说、经济学", @"username": @"豌豆", @"distance": @"22米"}];
    ...
    [self.infoArray addObject:@{@"favorite": @"历史政治", @"username": @"逍遥南华", @"distance": @"18米"}];
}
